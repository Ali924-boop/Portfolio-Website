...
import aboutImg from "../assets/Hero2bg.png"
  ...
  return (
    <div id="about" className="text-white py-16">
      <div className="container mx-auto px-4 text-center">
        ...
        I am a skilled software engineer specializing in web development and actively involved in various other projects.
        </motion.p>
          <motion.div
           ref={ref}
          ...
          className="flex flex-col md:flex-row justify-center items-center">
            ...
            className="md:w-1/2 text-gray-400 px-4 md:px-0 text-base sm:text-lg md:text-xl">
                Hey There! Hi, I'm Ali Raza, a passionate web developer dedicated to creating dynamic and user-friendly websites. I love turning ideas into reality through clean, efficient, and innovative code. With a keen eye for detail and a drive for continuous learning, I strive to stay updated with the latest web technologies to deliver the best solutions.
            </motion.p>
          </motion.div>
          <motion.div
          ref={ref}
          ...
          className="flex flex-col sm:flex-row justify-around items-center mt-12 space-y-6 sm:space-y-0 ">
            <div className="text-center">
                ...
                className="text-sm sm:text-base text-gray-300">Years of Design Experince</motion.p>
            </div>
