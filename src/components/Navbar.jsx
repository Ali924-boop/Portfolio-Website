  ...
  return (
    <div id="navbar">
      ...
      >
        ...
        <a
          href="/AR CV.pdf"
          download="Ali_Raza_CV.pdf"
          className="md:text-base lg:text-lg bg-purple-400 text-white px-4 py-2 rounded-full cursor-pointer"
        >
          Download CV
        </a>
      </motion.div>
            ...
            {menu && (
              <div className="flex flex-col justify-center items-center">
                ...
                <a
                  href="/AR CV.pdf"
                  download="Ali_Raza_CV.pdf"
                  className="text-lg bg-purple-500 hover:bg-purple-400 text-white px-4 py-2 mt-6 rounded-full cursor-pointer"
                >
                  Download CV
                </a>
              </div>
